        ...
        <StyledFeedbackActions>
          <ActionButton
            action={{
              ...
              Url: Conference2024.ConferenceFeedbackLink,
              Category: 'conference',
            }}
          />
          <ActionButton
            action={{ Title: 'Session feedback', Url: Conference2024.SessionFeedbackLink, Category: 'conference' }}
          />
        </StyledFeedbackActions>
      )}
      <span></span>
        ...
        render={(agendaSessions, nextSessionGroup, onSelect) => {
          return (
            <AgendaProvider
              ...
              sponsors={sponsors}
              rooms={Conference2024.RoomNames}
              livestreams={Conference2024.Livestreams}
            >
              {Conference2024.ShowNextSessions && nextSessionGroup && nextSessionGroup.sessions.length > 0 && (
                <StyledUpNext>
                  <h2>Up next</h2>
                  <StyledAgendaRow>
              ...
              <StyledAgendaContainer>
                <StyledAgendaRowList>
                  <li>Time</li>
                  {Conference2024.RoomNames.map((name) => (
                    <li key={name}>{name}</li>
                  ))}
                </StyledAgendaRowList>
                <StyledAgendaRow>
...
Agenda2024.displayName = 'CurrentAgenda'
