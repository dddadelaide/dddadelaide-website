...
import Agenda, { AgendaProps } from '../../components/agenda'

const TwentyNineteenAgenda: StatelessComponent<AgendaProps> = ({ SessionCell }) => (
  <Fragment>
...
export default Agenda(TwentyNineteenAgenda, { numTracks: 2 })
